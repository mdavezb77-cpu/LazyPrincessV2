...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6033503442').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mdavezb77_db_user:no-lbiggestloser@#$_74@moviebot7.xihdg5h.mongodb.net/?appName=Moviebot7")
DATABASE_NAME = environ.get('DATABASE_NAME', "Moviebot7")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'mSxClfWKY0h7Jhte5hMWYp2GutP2')
